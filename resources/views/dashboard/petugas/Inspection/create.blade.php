...
<main>
    <div class="container-fluid px-4 mt-4">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item"><a href="{{ route('dashboard.petugas.inspection.index') }}">Pemeriksaan</a></li>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('dashboard.petugas.inspection.store') }}" method="POST">
                    @csrf
