...
<div class="container-fluid px-4">
    <h1 class="mt-4">Perbaiki Data Balita</h1>
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item active">Perbaiki Data Balita</li>
    </ol>
    <div class="row mt-4">
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.petugas.balita.update', $balita->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
