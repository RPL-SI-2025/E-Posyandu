...
class InspectionPetugasController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.petugas.inspection.index', compact('inspections', 'eventtimes'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.petugas.inspection.create', compact('children', 'eventtimes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dashboard.petugas.inspection.index')->with('success', 'Data berhasil ditambahkan');
    }
    ...
    public function edit(Inspection $inspection)
    {
        ...
        $children = Child::all();
        $eventtimes = Eventtime::all();
        return view('dashboard.petugas.inspection.edit', compact('inspection', 'children', 'eventtimes'));
    }
    ...
    public function update(Request $request, Inspection $inspection)
    {
        ...
        return redirect()->route('dashboard.petugas.inspection.index')->with('success', 'Data pemeriksaan berhasil diperbarui');
    }
    ...
    public function destroy(Inspection $inspection)
    {
        ...
        return redirect()->route('dashboard.petugas.inspection.index')->with('success', 'Data pemeriksaan berhasil dihapus');
    }
}
